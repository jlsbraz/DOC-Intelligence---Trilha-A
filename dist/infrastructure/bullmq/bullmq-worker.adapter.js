...
let BullMQWorkerAdapter = BullMQWorkerAdapter_1 = class BullMQWorkerAdapter {
    processingService;
    worker = null;
    logger = new common_1.Logger(BullMQWorkerAdapter_1.name);
    constructor(processingService) {
        this.processingService = processingService;
    }
    async onModuleInit() {
        if (config_1.config.mock.enabled) {
...
exports.BullMQWorkerAdapter = BullMQWorkerAdapter = BullMQWorkerAdapter_1 = __decorate([
